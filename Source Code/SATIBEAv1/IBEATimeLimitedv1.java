...
public class IBEATimeLimitedv1 extends Algorithm {
     ...
     */
    public IBEATimeLimitedv1(Problem problem, long maxRunTimeMS,SAT_Decision sat_dec) {
        super(problem);
    ...
    public SolutionSet execute() throws JMException, ClassNotFoundException {
        ...
        while (elapsed < this.maxRunTimeMS) {
            ...
            while (offSpringSolutionSet.size() < populationSize) {
                ...
                } while (j < IBEATimeLimitedv1.TOURNAMENTS_ROUNDS); // do-while
                int k = 0;
                do {
                    k++;
                    parents[1] = (Solution) selectionOperator.execute(archive);
                } while (k < IBEATimeLimitedv1.TOURNAMENTS_ROUNDS); // do-while
