 ...
 */
public class SATIBEA_SettingsIBEAv1 extends Settings {
     ...
     * Constructor
     */
    public SATIBEA_SettingsIBEAv1(Problem p) {
        super(p.getName());
        problem_ = p;
    }
    
    
    public Algorithm configureSATIBEAv1(long maxRunTimeMS, String fm, int numFeat,List<List<Integer>> constr,String logpath) throws JMException {
        ...
        algorithm = new IBEATimeLimitedv1(problem_,maxRunTimeMS,sat_dec);
        ...
        mutation = new SATIBEA_NewMutationv1(parameters, fm,  numFeat, constr, sat_dec);
