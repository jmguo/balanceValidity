...
public class IBEATimeLimitedv3 extends Algorithm {
     ...
     */
    public IBEATimeLimitedv3(Problem problem, long maxRunTimeMS,SAT_Decision sat_dec) {
        super(problem);
    ...
    public SolutionSet execute() throws JMException, ClassNotFoundException {
        ...
        while (elapsed < this.maxRunTimeMS) {
            ...
            while (offSpringSolutionSet.size() < populationSize) {
                ...
                } while (j < IBEATimeLimitedv3.TOURNAMENTS_ROUNDS); // do-while
                int k = 0;
                do {
                    k++;
                    parents[1] = (Solution) selectionOperator.execute(archive);
                } while (k < IBEATimeLimitedv3.TOURNAMENTS_ROUNDS); // do-while
