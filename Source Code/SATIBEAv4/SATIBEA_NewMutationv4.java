...
public class SATIBEA_NewMutationv4 extends Mutation {
     ...
     */
    public SATIBEA_NewMutationv4(HashMap<String, Object> parameters, String fm, int nFeat, List<List<Integer>> constraints,SAT_Decision sat_dec) {
        super(parameters);
