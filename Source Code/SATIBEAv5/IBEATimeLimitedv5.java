...
public class IBEATimeLimitedv5 extends Algorithm {
     ...
     */
    public IBEATimeLimitedv5(Problem problem, long maxRunTimeMS,SAT_Decision sat_dec) {
        super(problem);
...
//        }
    ...
    public SolutionSet execute() throws JMException, ClassNotFoundException {
        ...
        blacklist = new HashSet<Integer>();//用于存放违背约束的位置
        ...
        start = System.currentTimeMillis();	//时间重新设定
        ...
        while (elapsed < this.maxRunTimeMS) {
            ...
            while (offSpringSolutionSet.size() < populationSize) {
                ...
                } while (j < IBEATimeLimitedv5.TOURNAMENTS_ROUNDS); // do-while
                int k = 0;
                do {
                    k++;
                    parents[1] = (Solution) selectionOperator.execute(archive);
                } while (k < IBEATimeLimitedv5.TOURNAMENTS_ROUNDS); // do-while
