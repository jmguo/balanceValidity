...
public class SATIBEA_SinglePointCrossover_Drupal extends Crossover {
  /**
   * Valid solution types to apply this operator 
   */
  private static final List VALID_TYPES = Arrays.asList(SATIBEA_BinarySolution_Drupal.class, BinarySolutionType.class,
   ...
   */
  public SATIBEA_SinglePointCrossover_Drupal(HashMap<String, Object> parameters) {
  	super(parameters) ;
    ...
    try {
      if (PseudoRandom.randDouble() < probability) {
        if ((parent1.getType().getClass() == BinarySolutionType.class) ||
            ...
            parent1.getType().getClass() == SATIBEA_BinarySolution_Drupal.class) {
  ...
  public Object execute(Object object) throws JMException {
    ...
    for (int i = 0; i < offSpring.length; i++) {
      offSpring[i].setCrowdingDistance(0.0); //默认赋值用距离
