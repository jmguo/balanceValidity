 ...
 * @author chris
 */
public class IBEATimeLimitedDrupal extends Algorithm {
     ...
     */
    public IBEATimeLimitedDrupal(Problem problem, long maxRunTimeMS,SAT_Decision sat_dec) {
        super(problem);
    ...
    public SolutionSet execute() throws JMException, ClassNotFoundException {
        ...
        while (elapsed < this.maxRunTimeMS) {
            ...
            while (offSpringSolutionSet.size() < populationSize) {
                ...
                } while (j < IBEATimeLimitedDrupal.TOURNAMENTS_ROUNDS); // do-while
                int k = 0;
                do {
                    k++;
                    parents[1] = (Solution) selectionOperator.execute(archive);
                } while (k < IBEATimeLimitedDrupal.TOURNAMENTS_ROUNDS); // do-while
