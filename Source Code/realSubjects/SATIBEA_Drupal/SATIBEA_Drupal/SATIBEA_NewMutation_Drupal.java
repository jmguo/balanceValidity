...
public class SATIBEA_NewMutation_Drupal extends Mutation {
     ...
     */
    public SATIBEA_NewMutation_Drupal(HashMap<String, Object> parameters, String fm, int nFeat, List<List<Integer>> constraints, SAT_Decision sat_dec2) {
        super(parameters);
