 ...
 */
public class SATIBEA_SettingsIBEAv5_Drupal extends Settings {
     ...
     * Constructor
     */
    public SATIBEA_SettingsIBEAv5_Drupal(Problem p) {
        super(p.getName());
        problem_ = p;
    ...
    public Algorithm configureSATIBEA(long maxRunTimeMS, String fm, int numFeat,List<List<Integer>> constr,String logpath) throws JMException {
        ...
        algorithm = new IBEATimeLimitedv5Drupal(problem_,maxRunTimeMS,sat_dec);
        ...
        crossover = new SATIBEA_SinglePointCrossover_Drupal(parameters);

        parameters = new HashMap();
        parameters.put("probability", mutationProbability_);
        mutation = new SATIBEAv5_NewMutation_Drupal(parameters, fm, numFeat, constr, sat_dec);
