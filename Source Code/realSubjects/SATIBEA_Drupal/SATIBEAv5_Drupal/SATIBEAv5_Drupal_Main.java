...
import satibeaVariants.SATIBEA_SettingsIBEAv5_Drupal;

public class SATIBEAv5_Drupal_Main{
    ...
    public static void main(String[] args) throws Exception {
    	...
    	try{
            ...
            /*************/
            String ResultDirectory = "SATIBEAv5realDrual_result";
            ...
            for(int count = 0;count<program_timeout_ms.length;count++)
            {
            	...
            	for(int i = 0; i< systems.length; i++){
            		...
            		while(loop > 0){
            			/********************/
            			outputFileSATibea = Outpath + systems[i] + ".SATibeav5realD-"+(program_timeout_ms[count]/6000)+"m.out." + loop;

            			p = new SATIBEA_Problem_Drupal(fm, augment, faults, mandatory);
            			a = new SATIBEA_SettingsIBEAv5_Drupal(p).configureSATIBEA(program_timeout_ms[count], fm, 
            			...
            			System.out.println("evaluation times：SATibeav5realD-"+(program_timeout_ms[count]/6000)+"m_"+
