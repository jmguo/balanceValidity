 ...
 */
public class SATIBEA_BinarySolution_Amazon extends BinarySolutionType {
    ...
    public SATIBEA_BinarySolution_Amazon(Problem problem, int nFeat, String fm, List<Integer> mandatoryFeaturesIndices) {
        super(problem);
        this.fm = fm;
        this.nFeat = nFeat;
