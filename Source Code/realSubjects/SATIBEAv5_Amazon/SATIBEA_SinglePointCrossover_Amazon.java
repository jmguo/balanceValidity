...
public class SATIBEA_SinglePointCrossover_Amazon extends Crossover {
  /**
   * Valid solution types to apply this operator 
   */
  private static final List VALID_TYPES = Arrays.asList(SATIBEA_BinarySolution_Amazon.class, BinarySolutionType.class,
   ...
   */
  public SATIBEA_SinglePointCrossover_Amazon(HashMap<String, Object> parameters) {
  	super(parameters) ;
    ...
    try {
      if (PseudoRandom.randDouble() < probability) {
        if ((parent1.getType().getClass() == BinarySolutionType.class) ||
            ...
            parent1.getType().getClass() == SATIBEA_BinarySolution_Amazon.class) {
