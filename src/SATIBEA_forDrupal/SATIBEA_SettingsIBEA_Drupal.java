 ...
 */
public class SATIBEA_SettingsIBEA_Drupal extends Settings {
     ...
     * Constructor
     */
    public SATIBEA_SettingsIBEA_Drupal(Problem p) {
        super(p.getName());
        problem_ = p;
    ...
    public Algorithm configureSATIBEA(long maxRunTimeMS, String fm, int numFeat,List<List<Integer>> constr,String logpath) throws JMException {
        ...
        algorithm = new IBEATimeLimitedDrupal(problem_,maxRunTimeMS,sat_dec);
        ...
        mutation = new SATIBEA_NewMutation_Drupal(parameters, fm, numFeat, constr, sat_dec);
