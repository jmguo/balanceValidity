...
public class SATIBEA_NewMutationv1 extends Mutation {
     ...
     */
    public SATIBEA_NewMutationv1(HashMap<String, Object> parameters, String fm, int nFeat, List<List<Integer>> constraints,SAT_Decision sat_dec) {
        super(parameters);
