...
public class SATIBEA_NewMutationv2 extends Mutation {
     ...
     */
    public SATIBEA_NewMutationv2(HashMap<String, Object> parameters, String fm, int nFeat, List<List<Integer>> constraints,SAT_Decision sat_dec) {
        super(parameters);
            ...
            try {
                if ((solution.getType().getClass() == BinarySolutionType.class)
                    ...
                    for (int i = 0; i < solution.getDecisionVariables().length; i++) {
                        ...
                        for (Integer j : SATIBEA_Problemv2.featureIndicesAllowedFlip) { //flip only not "fixed" features
...
//                System.out.println("Replace (ms) " + (System.currentTimeMillis() - t));
                ...
                for (int i = 0; i < solution.getDecisionVariables().length; i++) {
                    ...
                    if (violated > 0) {
                        ...
                        for (int j = 0; j < SATIBEA_Problemv2.numFeatures; j++) {
                            int feat = j + 1;
