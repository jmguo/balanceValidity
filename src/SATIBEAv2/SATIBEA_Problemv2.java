...
public class SATIBEA_Problemv2 extends Problem {
    ...
    public SATIBEA_Problemv2(String fm, String augment, String mandatory, String dead, String seedfile) throws Exception {
    ...
    public void evaluate(Solution sltn) throws JMException {
        ...
        for (int i = 0; i < bin.getNumberOfBits(); i++) {
            ...
            if (!b) {
                ...
                cost_ += cost[i];//被选中中了，某个特征，则其代价累加
                if (used_before[i]) {//之前是否被使用
                    defect += defects[i];
                } else {
                    unused++;
                }
