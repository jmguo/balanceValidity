 ...
 */
public class SATIBEA_SettingsIBEAv3 extends Settings {
     ...
     * Constructor
     */
    public SATIBEA_SettingsIBEAv3(Problem p) {
        super(p.getName());
        problem_ = p;
    }
    
    
    public Algorithm configureSATIBEAv3(long maxRunTimeMS, String fm, int numFeat,List<List<Integer>> constr,String logpath) throws JMException {
        ...
        algorithm = new IBEATimeLimitedv3(problem_,maxRunTimeMS,sat_dec);
        ...
        mutation = new SATIBEA_NewMutationv3(parameters, fm,  numFeat, constr, sat_dec);
