 ...
 */
public class SATIBEA_SettingsIBEAv5 extends Settings {
     ...
     * Constructor
     */
    public SATIBEA_SettingsIBEAv5(Problem p) {
        super(p.getName());
        problem_ = p;
    }
    
    
    public Algorithm configureSATIBEAv5(long maxRunTimeMS, String fm, int numFeat,List<List<Integer>> constr,String logpath) throws JMException {
        ...
        algorithm = new IBEATimeLimitedv5(problem_,maxRunTimeMS,sat_dec);
        ...
        mutation = new SATIBEA_NewMutationv5(parameters, fm,  numFeat, constr, sat_dec);
